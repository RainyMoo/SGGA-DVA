from models.model_loader import CfgLoader
...
def parse_args():
    ...
    parser.add_argument('--LAMDA', dest='LOSS_LAMDA',
                      help="lamda choose, eg.'0.1, 0.2, ...'",
                      type=float)
    ...
    parser.add_argument('--ITC', dest='ITC_LOSS',
                      choices=['True', 'False'],
                      help='choose wether use itc',
                      type=str)
    
    parser.add_argument('--BERT', dest='USE_BERT',
                      choices=['True', 'False'],
                      help='choose wether use bert for ques embedding',
                      type=str)
...
if __name__ == '__main__':
    ...
    cfg_file = "configs/{}_{}.yml".format(args.MODEL, args.DATASET)
